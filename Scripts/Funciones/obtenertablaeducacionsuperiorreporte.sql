-- Function: obtenertablaeducacionsuperiorreporte(integer, date)

-- DROP FUNCTION obtenertablaeducacionsuperiorreporte(integer, date);

CREATE OR REPLACE FUNCTION obtenertablaeducacionsuperiorreporte(integer, date)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION obtenertablaeducacionsuperiorreporte(integer, date) OWNER TO postgres;
